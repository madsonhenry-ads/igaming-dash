...
const mainNavItems = [
  ...
  { title: 'Traffic Sources', url: '/admin/traffic-sources', icon: Target },
  { title: 'Segments', url: '/admin/segments', icon: Tag },
  { title: 'Emails', url: '/admin/emails', icon: Mail },
];

const marketingNavItems = [
  { title: 'Facebook Ads', url: '/admin/facebook', icon: Megaphone },
  { title: 'Reports', url: '/admin/reports', icon: BarChart3 },
  { title: 'API Analytics', url: '/admin/api-analytics', icon: LineChart },
];
          ...
          <SidebarMenuItem>
            <div className="flex items-center gap-3 px-2 py-1.5">
              ...
              <div className="flex flex-col">
                <span className="text-sm font-bold">CRM Dashboard</span>
